...
public class MQTTActivity extends AppCompatActivity implements MQTTConnectFragment.ConnectDataPassListener, MQTTPublishFragment.PublishDataPassListener, MqttCallback, MQTTSubscribeFragment.SubscribeDataPassListener {
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.fragment_container) != null) {
            ...
            MQTTSubscribeFragment connectFragment = new MQTTSubscribeFragment();
